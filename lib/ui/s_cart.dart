...
class _ShoppingCartState extends State<ShoppingCart> {
  ...
  returnAlert() {
    return Alert(
        ...
        desc: "Please paste in the payment confirmation message and please enter the destination where we should deliver.",
        context: context,
        content: Column(
          children: <Widget>[
            TextField(
